...
#define CACHE_SET_TAG_BYTE_TO_BINARY_PATTERN "[%c%c]%c%c%c%c"
#define CACHE_SET_INDEX_BYTE_TO_BINARY_PATTERN "%c%c[%c%c]%c%c"
#define CACHE_SET_BLOCK_OFFSET_BYTE_TO_BINARY_PATTERN "%c%c%c%c[%c%c]"
